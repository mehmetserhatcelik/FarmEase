...
public class FieldsU extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFieldsUBinding.inflate(getLayoutInflater());
        ...
        list = new ArrayList<>();
        myAdapter = new MyAdapter (FieldsU.this, list,this );
        ...
        database.get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        {
                            Toast.makeText(FieldsU.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    {
        Intent intent = new Intent(FieldsU.this, BottomMainActivity.class);
        startActivity(intent);
        finish();
    }
    public void goAddField(View v)
    {
        Intent intent = new Intent(FieldsU.this,AddField.class);
        startActivity(intent);
        finish();
    }
    ...
    public void onItemClick(int pos) {
        ...
        Intent intent = new Intent(FieldsU.this, FieldInfo.class);
